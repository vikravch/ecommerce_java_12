...
const SortItem = () => {
	...
	const [sortItem, setSortItem] = React.useState(list[0].title)
	...
	const handleTogglePopup = (target) => {
		setTogglePopup(prevState => !prevState)
		console.log(target)
		
		// closePopup(target)
		// let result = document.body.querySelector('body')
		// result.onclick(()=> {
		// 	setTogglePopup(prevState => !prevState)
		// })
	}
	
	const handleChangeSortItem = (title) => {
		setSortItem(title)
